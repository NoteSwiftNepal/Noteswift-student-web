...
function AskDoubtContent() {
  ...
  return (
    <div className="mx-auto max-w-2xl space-y-6">
      <div>
        <h1 className="text-2xl font-bold text-foreground">Ask a Doubt</h1>
        <p className="text-sm text-muted-foreground">Post a question — the assigned teacher gets notified.</p>
      </div>
        ...
        <CardContent className="p-5">
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="space-y-2">
              ...
              <Input id="title" value={title} onChange={(e) => setTitle(e.target.value)} placeholder="Short summary of your doubt" />
            </div>
            ...
            <div className="space-y-2">
              ...
              {attachment ? (
                <div className="flex items-center gap-3 rounded-lg border border-border p-2">
                  ...
                  <img src={attachment.url} alt={attachment.name} className="size-16 rounded object-cover" />
